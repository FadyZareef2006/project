      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="text-amber-500 hidden md:flex items-center space-x-8">
            ...
            <Link to="/quote" className="bg-amber-800 text-black px-4 py-2 rounded-md hover:bg-amber-500">
              Get a Quote
            </Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link to="/quote" className="block px-3 py-2 bg-blue-600 text-white rounded-md">Get a Quote</Link>
          </div>
        </div>
      )}
    </nav>
