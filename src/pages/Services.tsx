...
export default function Services() {
  const services = [
    {
      icon: <Building2 className="h-12 w-12 text-black" />,
    ...
    {
      icon: <Home className="h-12 w-12 text-black" />,
    ...
    {
      icon: <Warehouse className="h-12 w-12 text-black" />,
    ...
    {
      icon: <PaintBucket className="h-12 w-12 text-black" />,
    ...
    {
      icon: <HardHat className="h-12 w-12 text-black" />,
    ...
    <div className="pt-16">
      ...
      <section className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-amber-300 mb-4">Our Services</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-amber-300 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
      ...
      <section className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-amber-300">Our Process</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-amber-300">
            {[
              ...
              <div key={index} className="text-center">
                <div className="text-amber-300 font-bold text-xl mb-2">{phase.step}</div>
                <h3 className="text-xl font-semibold mb-2">{phase.title}</h3>
                <p className="text-amber-500">{phase.description}</p>
              </div>
            ))}
          </div>
        </div>
